export default `<!DOCTYPE html><html lang="en" data-beasties-container><head><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <meta charset="UTF-8">
  <title>Muhammad Saad Abid - Frontend Engineer</title>
  <base href="/">
  ...
  <!-- Font Awesome for icons (e.g., download icon, social media icons) -->
  ...
  <style>
    ...
    /* Custom animation for elements fading in */
...
<body><!--nghm-->
  <app-root ng-version="20.0.2" ngh="0" ng-server-context="ssg"></app-root>
<script src="polyfills-B6TNHZQ6.js" type="module"></script><script src="main-5ONRL57Q.js" type="module"></script>
